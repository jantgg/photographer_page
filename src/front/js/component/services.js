...
const Services = ({ data, groupSize }) => {
  ...
  const isNotMobile = window.innerWidth >= 1400;

  return (
    <>
      {isNotMobile ? (<div className="d-flex flex-column">
        ...
        <div className="col-11 serviceh mx-auto service-top d-flex">
          <div className="col-6 d-flex">
            <div className="col-12 h100 pe-3 image-container"> <img src={me} alt="Background Image" className="img-style" /></div>
          </div>
          <div className="col-6 d-flex white ps-3">
